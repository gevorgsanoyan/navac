# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-06 06:28
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pfDate', models.DateField(default=datetime.datetime(2017, 6, 6, 6, 28, 58, 91150, tzinfo=utc))),
        ...
        migrations.AddField(
            model_name='stock',
            name='sType',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='stock.stockTypes'),
        ),
    ]
